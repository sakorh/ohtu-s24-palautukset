...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_jalkeen_tilisiirtoa_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_kahden_eri_ostoksen_jalkeen_tilisiirtoa_kutsutaan_oikeilla_parametreilla(self):
    ...
    def test_tilisiirtoa_kutsutaan_oikeilla_parametreilla_kun_ostettava_tuote_on_loppu(self):
    ...
    def test_aloita_asioiminen_nollaa_edelliset_ostokset(self):
    ...
    def test_tuotteen_poisto_korista_asettaa_varaston_saldon_oikein(self):
